  ...
  create  table "postgres"."dbt"."rep_order_cnt_week__dbt_tmp"
  as (
    ...
    from "postgres"."dbt"."hub_order" as ho
    left join "postgres"."dbt"."sat_order_details" as sod 
    on ho.order_pk=sod.order_pk
    -- inner join "postgres"."dbt"."dim_day" as d 
